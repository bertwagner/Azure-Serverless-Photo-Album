...
fetch('https://serverlessphotostorage.blob.core.windows.net/photos/'+folderName+'/photos.json',
{
    method: 'get',
...
return Promise.reject(response);
    ...
    {
        var fullSize = "https://serverlessphotostorage.blob.core.windows.net/photos/"+folderName+"/"+data[i].name;
        var fullDimensions = data[i].width+'x'+data[i].height;
        var mediumSize = "https://serverlessphotostorage.blob.core.windows.net/photos/"+folderName+"/medium/"+data[i].name;
        ...
        var newNode = htmlToElem('<a href="'+fullSize+'" data-size="'+fullDimensions+'" data-med="'+fullSize+'" data-med-size="'+fullDimensions+'"> \
            <img src="'+smallSize+'" width="'+data[i].small_width+'" height="'+data[i].small_height+'" alt="" /> \
        </a>')
